    ...
    <asp:ListView ID="ListView1" runat="server" DataSourceID="SpecialEventsDataSource" InsertItemPosition="LastItem">
        ...
        <ItemTemplate>
            <div>
                ...
                <asp:Label ID="Label1" runat="server" AssociatedControlID="EventCodeLabel" CssClass="control-label">EventCode:</asp:Label>
                <asp:Label Text='<%# Eval("EventCode") %>' runat="server" ID="EventCodeLabel" ></asp:Label>
                
                <asp:Label ID="Label2" runat="server" AssociatedControlID="EventCodeLabel" CssClass="control-label">Description:</asp:Label>
